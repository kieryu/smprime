...
$wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}city");
	...
	update_option('tc_auto_plugin_version','2.3');
		}
    ...
    <div id="tc_auto_plugin_meta_pro" class="tc_auto_plugin_meta_pro postbox">
      ...
      <div class="inside">
        ...
        <p>Having Any Issue?<br><a href="https://wordpress.org/support/plugin/country-state-city-auto-dropdown/" target="_blank" style='font-weight: bold;color: #bb2c2c;'>Get support &rarr;</a></p>
          <p>You can check Live Demo of <a href="http://trustyplugins.com" target="_blank" style='font-weight: bold;color: #bb2c2c;'>PRO</a> Plugin too. You can extend the functionality of this plugin with these awesome features.<br>
		  <ol>
		  ...
		  <a href="http://trustyplugins.com" target="_blank" style='font-weight: bold;background: #bb2c2c;color: #fff;padding: 8px 12px;display: inline-block;text-decoration: none;width: 90%;text-align: center;'>BUY PRO &rarr;</a></p>
      </div>
    </div>
    <?php             
...
function tc_csca_plugin_row_meta( $links, $file ) {    
    if ( plugin_basename( __FILE__ ) == $file ) {
        $row_meta = array(
          'Buy PRO'    => '<a href="' . esc_url( 'http://trustyplugins.com/' ) . '" target="_blank" aria-label="' . esc_attr__( 'Plugin Additional Links', 'domain' ) . '" style="color:red;">' . esc_html__( 'Buy Pro', 'domain' ) . '</a>'
        );
