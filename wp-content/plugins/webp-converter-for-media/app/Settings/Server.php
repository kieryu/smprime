      ...
      <table>
        <tbody>
          <tr>
            ...
            <td class="v">
              <?= $this->getFileSizeByPath($uploadsPath . Errors::PATH_OUTPUT_FILE_PNG); ?>
            </td>
          </tr>
          <tr>
            <td class="e">Size of PNG2 <em>(by server path)</em></td>
            <td class="v">
              <?= $this->getFileSizeByPath($uploadsPath . Errors::PATH_OUTPUT_FILE_PNG2); ?>
            </td>
          </tr>
          <tr>
            <td class="e">Size of PNG as WEBP <em>(by URL)</em></td>
            <td class="v">
              <?= $this->getFileSizeByUrl($uploadsUrl . Errors::PATH_OUTPUT_FILE_PNG); ?>
            </td>
          </tr>
          <tr>
            <td class="e">Size of PNG as PNG <em>(by URL)</em></td>
            <td class="v">
              <?= $this->getFileSizeByUrl($uploadsUrl . Errors::PATH_OUTPUT_FILE_PNG, false); ?>
            </td>
          </tr>
          <tr>
            <td class="e">Size of PNG2 as WEBP <em>(by URL)</em></td>
            <td class="v">
              <?= $this->getFileSizeByUrl($uploadsUrl . Errors::PATH_OUTPUT_FILE_PNG2); ?>
            </td>
          </tr>
          <tr>
            <td class="e">Size of PNG2 as PNG2 <em>(by URL)</em></td>
            <td class="v">
              <?= $this->getFileSizeByUrl($uploadsUrl . Errors::PATH_OUTPUT_FILE_PNG2, false); ?>
            </td>
          </tr>
        </tbody>
      </table>
